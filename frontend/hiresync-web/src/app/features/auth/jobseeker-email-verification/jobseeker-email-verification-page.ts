...
@Component({
  selector: 'app-jobseeker-email-verification-page',
  imports: [
    DatePipe,
    ReactiveFormsModule,
    RouterLink,
  ...
  templateUrl:
    './jobseeker-email-verification-page.html',
  styleUrl:
    './jobseeker-email-verification-page.css',
})
export class JobSeekerEmailVerificationPage
  implements OnInit
{
  ...
  ngOnInit(): void {
    ...
    if (!email) {
      this.errorMessage.set(
        'Job Seeker email is required to continue verification.',
      );
      return;
    }
