...
public sealed class JobSeekerEmailVerificationServiceTests
{
    [Fact]
    ...
    [Fact]
    public async Task RequestAsync_rejects_employer_without_requesting_otp()
    {
        using var environment =
            await CreateEnvironmentAsync();
    ...
    [Fact]
    public async Task RequestAsync_rejects_suspended_job_seeker_without_requesting_otp()
    {
        using var environment =
            await CreateEnvironmentAsync();
    ...
    [Fact]
    public async Task RequestAsync_rejects_already_verified_job_seeker_without_requesting_otp()
    {
        using var environment =
            await CreateEnvironmentAsync();
    ...
    [Fact]
    public async Task VerifyAsync_rejects_non_job_seeker_account_without_consuming_otp()
    {
        using var environment =
            await CreateEnvironmentAsync();
    ...
    private static JobSeekerEmailVerificationService CreateService(
        TestEnvironment environment,
        IEmailOtpService otpService)
    {
        return new JobSeekerEmailVerificationService(
            environment.Context,
    ...
    private static Task<ApplicationUser> CreateJobSeekerAsync(
        TestEnvironment environment,
        string email)
    {
            ...
            IInterceptor? interceptor = null)
    {
        ...
        var databaseName =
            $"HireSyncJobSeekerEmailVerificationTests_{Guid.NewGuid():N}";
